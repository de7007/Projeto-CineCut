    ...
    <body>
        <header>
            ...
            <nav class="navbar navbar-expand-lg">
                <!-- Logo -->
                <figure class="logo">
                    <img src="letterboxd-main/filmes/imagens/icon.png" width="45" height="auto"/>
                </figure>
        ...
        <main>
                ...
                <div id="carouselExampleFade" class="carousel slide carousel-fade">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="letterboxd-main/filmes/imagens/superman.png" class="d-block w-100" alt="Banner filme Superman 2025">
                        </div>
                        <div class="carousel-item">
                            <img src="letterboxd-main/filmes/imagens/f1.png" class="d-block w-100" alt="Banner filme F1 2025">
                        </div>
                        <div class="carousel-item">
                            <img src="letterboxd-main/filmes/imagens/amores.png" class="d-block w-100" alt="Banner filme Amores Materialistas">
                        </div>
            ...
            <section class="apresentacaoFotos">
                <div class="container text-center">
                    <div class="row">
                        <div class="col">
                        <img src="letterboxd-main/filmes/imagens/parasita.png" alt="Poster do filme Parasita" width="150px" height="auto" class="rounded" href="../parasita.php">
                        </div>
                        <div class="col">
                        <img src="letterboxd-main/filmes/imagens/moonlight.png" alt="Poster do filme Moonlight" width="150px" height="auto" class="rounded" href="../moonlight.php">
                        </div>
                        <div class="col">
                        <img src="letterboxd-main/filmes/imagens/chihiro.png" alt="Poster do filme A viagem de Chihiro" width="150px" height="auto" class="rounded" href="../chihiro.php">
                        </div>
                        <div class="col">
                        <img src="letterboxd-main/filmes/imagens/sunshine.png" alt="Poster do filme Brilho eterno de uma mente sem lembranças" width="150px" height="auto" class="rounded" href="../sunshine.php">
                        </div>
                        <div class="col">
                        <img src="letterboxd-main/filmes/imagens/brokeback.png" alt="Poster do filme O segredo de Brokeback" width="150px" height="auto" class="rounded" href="../brokeback.php">
                        </div>
                        <div class="col">
                        <img src="letterboxd-main/filmes/imagens/bastardos.png" alt="Poster do filme Bastardos Inglórios" width="150px" height="auto" class="rounded" href="../bastardos.php">
                        </div>
                    </div>
                    </div>
                </div>
