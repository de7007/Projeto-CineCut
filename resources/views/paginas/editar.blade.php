<x-layout titulo="Editar">
    <head>
        <link rel="stylesheet" href="../letterboxd-main/filmes/css/editar.css">
    </head>
    <body>
        <header>
            <!-- Barra de tarefas -->
        ...
        <form class="form-control" action="../atualizar/{{$dado->id}}" method="GET">
            ...
            <a class="btn btn-success" href="../consultar">Voltar</a>
            
            <!--BOTAO MODAL-->
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal">Excluir</button>
            <!--MODAL-->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success" data-bs-dismis="modal">Não</button>
                            <a type="button" class="btn btn-success" href="/excluir/{{$dado->id}}">Sim</a>
                        </div>
                    </div>
                </div>
            </div>
