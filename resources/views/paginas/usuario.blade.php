<x-layout titulo="Usario - CineCut">
    <head>
        <link rel="stylesheet" href="letterboxd-main/filmes/css/usuario.css">
    </head>
        <body>
            <header>
            <!-- Barra de tarefas -->
        ...
        <!-- Barra de usuário + botão de avaliação -->
        <main>
            <section class="user">
                <div class="container">
                    <div class="row">
                        <div class="col1">
                            <figure class="perfil">
                                <img src="letterboxd-main/filmes/imagens/perfil.png" width="100" height="auto"/>
                            </figure>
                        </div>
                        <div class="col2">    
                            <h4>Mario</h4>
                        ...
                        <div class="col3">
                            <a href="cadastrar"><button type="button" class="btn btn-success">Avalie agora</button></a>
                        </div>
                    </div>
                </div>
                <div class="icons">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-film" viewBox="0 0 16 16"><path d="M0 1a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1zm4 0v6h8V1zm8 8H4v6h8zM1 1v2h2V1zm2 3H1v2h2zM1 7v2h2V7zm2 3H1v2h2zm-2 3v2h2v-2zM15 1h-2v2h2zm-2 3v2h2V4zm2 3h-2v2h2zm-2 3v2h2v-2zm2 3h-2v2h2z"/></svg> 4 Filmes assistidos <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16"><path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.56.56 0 0 0-.163-.505L1.71 6.745l4.052-.576a.53.53 0 0 0 .393-.288L8 2.223l1.847 3.658a.53.53 0 0 0 .393.288l4.052.575-2.906 2.77a.56.56 0 0 0-.163.506l.694 3.957-3.686-1.894a.5.5 0 0 0-.461 0z"/></svg> 4 Reviews
                </div>
            </section>
            <!-- Análisa e Avaliação + Favoritos -->
            <section id="geral">        
                        ...
                        <div class="row">
                            ...
                            <div class="favoritos">
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="colf3">
                                            <img src="letterboxd-main/filmes/imagens/fav1.png" width="150" height="auto" class=rounded></img>
                                        </div>
                                        <div class="colf4">
                                            <img src="letterboxd-main/filmes/imagens/fav2.png" width="150" height="auto" class=rounded></img>
                                        </div>
                                        <div class="colf5">
                                            <img src="letterboxd-main/filmes/imagens/fav3.png" width="150" height="auto" class=rounded></img>
                                        </div>
                                        <div class="colf6">
                                            <img src="letterboxd-main/filmes/imagens/fav4.png" width="150" height="auto" class=rounded></img>
                                        </div>
                                        <div class="colf7">
